\hypertarget{_c_make_c_x_x_compiler_id_8cpp}{}\subsection{C\+Make\+Files/3.13.4/\+Compiler\+Id\+C\+X\+X/\+C\+Make\+C\+X\+X\+Compiler\+Id.cpp File Reference}
\label{_c_make_c_x_x_compiler_id_8cpp}\index{C\+Make\+Files/3.\+13.\+4/\+Compiler\+Id\+C\+X\+X/\+C\+Make\+C\+X\+X\+Compiler\+Id.\+cpp@{C\+Make\+Files/3.\+13.\+4/\+Compiler\+Id\+C\+X\+X/\+C\+Make\+C\+X\+X\+Compiler\+Id.\+cpp}}
...
\begin{DoxyCode}
580 \{
581   \textcolor{keywordtype}{int} require = 0;
582   require += \hyperlink{_c_make_c_x_x_compiler_id_8cpp_a4b0efeb7a5d59313986b3a0390f050f6}{info\_compiler}[argc];
583   require += \hyperlink{_c_make_c_x_x_compiler_id_8cpp_a2321403dee54ee23f0c2fa849c60f7d4}{info\_platform}[argc];
584 \textcolor{preprocessor}{#ifdef COMPILER\_VERSION\_MAJOR}
585   require += info\_version[argc];
586 \textcolor{preprocessor}{#endif}
587 \textcolor{preprocessor}{#ifdef COMPILER\_VERSION\_INTERNAL}
588   require += info\_version\_internal[argc];
589 \textcolor{preprocessor}{#endif}
590 \textcolor{preprocessor}{#ifdef SIMULATE\_ID}
591   require += info\_simulate[argc];
592 \textcolor{preprocessor}{#endif}
593 \textcolor{preprocessor}{#ifdef SIMULATE\_VERSION\_MAJOR}
594   require += info\_simulate\_version[argc];
595 \textcolor{preprocessor}{#endif}
596 \textcolor{preprocessor}{#if defined(\_\_CRAYXE) || defined(\_\_CRAYXC)}
597   require += info\_cray[argc];
598 \textcolor{preprocessor}{#endif}
599   require += \hyperlink{_c_make_c_x_x_compiler_id_8cpp_a1ce162bad2fe6966ac8b33cc19e120b8}{info\_language\_dialect\_default}[argc];
600   (void)argv;
601   \textcolor{keywordflow}{return} require;
602 \}
\end{DoxyCode}
